<section class="content background-grey">
    <div class="container">
        ...
        <div id="blog" class="grid-layout post-3-columns m-b-30 grid-loaded" data-item="post-item" style="margin: 0px -20px -20px 0px; position: relative; height: 518.958px;">
            <!-- Post item-->
            ...
            <!-- end: Post item-->
            <!-- Post item-->
            <div class="post-item border" style="padding: 0px 20px 20px 0px; position: absolute; left: 317.333px; top: 0px;">
                <div class="post-item-wrap">
                    <div class="post-image">
                        <a href="#">
            ...
            <!-- end: Post item-->
            <!-- Post item-->
            <div class="post-item border" style="padding: 0px 20px 20px 0px; position: absolute; left: 634.666px; top: 0px;">
                <div class="post-item-wrap">
                    <div class="post-image">
                        <a href="#">
